...
![my router]({{BLOG_URL}}/images/cloud-router.jpg)
...
![The Cube]({{BLOG_URL}}/images/cloud-cube.jpg)
...
<hr />
## section 3: setup #2
![optiplex 7060 SFF]({{BLOG_URL}}/images/cloud-optiplex.jpg)
<h5>The Plex</h5>
...
![truenas screenshot 1]({{BLOG_URL}}/images/cloud-scale-1.png)
![truenas screenshot 2]({{BLOG_URL}}/images/cloud-scale-2.png)
![shell screenshot]({{BLOG_URL}}/images/cloud-shell.png)
...
![Host Network option]({{BLOG_URL}}/images/cloud-scale-network.png)
...
![cloudflare tunnel panel example]({{BLOG_URL}}/images/cloud-tunnel.png)
...
if you've read this far, consider following me on my [bluesky](https://bsky.app/profile/dotevie.com) (i would really appreciate it), and i hope you liked the first real article i've written here!